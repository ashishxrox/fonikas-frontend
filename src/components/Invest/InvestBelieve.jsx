...
import Bg1 from '../../assets/main12.png';
    ...
    return (
        ...
        >
            ...
            <div className='h-[95%] md:h-[80%] w-[80%] flex justify-between items-center flex-col md:flex-row'>
                ...
                <div className='basis-[32%] h-full w-full  rounded-[12px] flex justify-between items-center flex-col py-[20px] bg-cover bg-center'
                style={{backgroundImage:`url("${Believe}")`}}
                >
                    <div className='h-[15%] w-[90%] ac-hover bg-[rgba(0,0,0,0.3)] backdrop-blur-[10px] rounded-[12px] flex justify-center items-center'
                    style={{ boxShadow: "2px 2px 5px #000" }}
                    >
                        <h2 className='titleText'>We Believe</h2>
                    </div>
                    <div className='h-[50%] w-[90%] ac-hover flex justify-center items-start flex-col gap-[10px] px-[25px] bg-[rgba(0,0,0,0.3)] backdrop-blur-[10px] rounded-[12px]'
                        style={{ boxShadow: "2px 2px 5px #000" }}>
