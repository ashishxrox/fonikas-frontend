...
const InvestLanding = () => {
    ...
    return (
        <div
            className='bg-black h-[1400px] md:h-[135vh] w-full flex justify-end items-center flex-col bg-center bg-cover bg-no-repeat'
        ...
        >
            ...
            <div className='basis-[55%] h-full w-[80%]'>
