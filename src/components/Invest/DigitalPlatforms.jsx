...
const DigitalPlatforms = () => {
    ...
    const items = [
        ...
        { id: 2, title: "Tailored Hedging & Risk Mitigation", content: "We structure client-specific hedging strategies using options, structured notes, and overlays—designed to protect against equity drawdowns, interest rate shocks, or FX risk.", color: "linear-gradient(23deg, rgba(0, 157, 157, 1) 54%, rgba(0, 180, 180, 1) 67%)" },
