...
const Hamburger = () => {
    ...
    return (
        <div className="mobile-container fixed w-full z-[99999] block md:hidden">
            <div className={`bg-[rgba(255,255,255,0.3)] backdrop-blur-[5px] px-[20px] h-[75px] flex justify-center items-center flex-col ${!menuOpen ? "rounded-bl-[24px] rounded-br-[24px]" : ""} `}
                ...
                <div className="h-full w-full flex justify-center items-center flex-row">
                    ...
                    <div className=" h-[30px] w-[50px] cursor-pointer relative text-[50px] top-[0%] text-white font-[500]" onClick={toggleMenu}>
                        {!menuOpen && <svg width="35" height="34" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M3.20703 5.6998C3.20703 5.20275 3.71276 4.7998 4.33662 4.7998H21.2773C21.9012 4.7998 22.4069 5.20275 22.4069 5.6998C22.4069 6.19686 21.9012 6.5998 21.2773 6.5998H4.33662C3.71276 6.5998 3.20703 6.19686 3.20703 5.6998Z" fill="#fff" />
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M3.20703 11.9293C3.20703 11.4322 3.71276 11.0293 4.33662 11.0293H21.2773C21.9012 11.0293 22.4069 11.4322 22.4069 11.9293C22.4069 12.4264 21.9012 12.8293 21.2773 12.8293H4.33662C3.71276 12.8293 3.20703 12.4264 3.20703 11.9293Z" fill="#fff" />
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M3.20703 18.1593C3.20703 17.6622 3.71276 17.2593 4.33662 17.2593H21.2773C21.9012 17.2593 22.4069 17.6622 22.4069 18.1593C22.4069 18.6563 21.9012 19.0593 21.2773 19.0593H4.33662C3.71276 19.0593 3.20703 18.6563 3.20703 18.1593Z" fill="#fff" />
                        </svg>}
